...
//        System.out.println("Bits array: " + Arrays.deepToString(bitsArray(toBinary(keyToMd5(key)))));
    ...
    static void moveLeftUp(int[][] captureArray) { //T == b, L == c, a
        if (iPos == 0) {
            if (jPos == 0);                     //a
            else jPos--;                        //T == b
    ...
    static void moveRightUp(int[][] captureArray) { //T == a, R == d, b
        if (iPos == 0) {
            if (jPos == 16);                    //b
            else jPos++;                        //a == T
    ...
    static void moveLeftDown(int[][] captureArray) { // B==d, L==a,c
        if (iPos == 8) {
            if (jPos == 0);                     //c
            else jPos--;                        //d == B
    ...
    static void moveRightDown(int[][] captureArray) { //B==c, R==b, d
        if (iPos == 8) {
            if (jPos == 16);                    //d
            else jPos++;                        //B == c
    ...
    static char[][] graphicKey (int[][] intArray) {
    ...
    static void printCaptureArray (char[][] array) {
        for(char[] a : array) {
    ...
    static void printFingerPrint (String fingerprint) {
